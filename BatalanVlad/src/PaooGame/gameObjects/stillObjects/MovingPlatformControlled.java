...
public class MovingPlatformControlled extends StillObject implements ISwitchable {
    ...
    public void Update(Map currentMap) {
        ...
        body.setCollisionState(currentMap.checkCollision(new Rectangle((int) nextPosition.getX(), (int) (nextPosition.getY() - maxOnPlatformHeight), body.getBodyWidth(), body.getBodyHeight() + maxOnPlatformHeight)));
