...
import PaooGame.actionTimers.timer.PeriodicFiniteActionTimer;
...
import PaooGame.graphics.gameWindow.button.buttonTypes.RestartGameButton;
import PaooGame.graphics.gameWindow.button.buttonTypes.ReturnFromGameToMainMenuButton;
...
public abstract class Level {
    ...
    public void resetLevel(){
        ...
        camera.cameraStart();
        camera.setFollowedObject(getPlayer());
